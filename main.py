"""
Agent Project Template - Main Entry Point
...
async def run_cli_mode() -> None:
    ...
    """
    print("🤖 Agent Project Template - CLI Mode")
    print("=" * 50)
    ...
    print("Welcome to the Agent Project Template!")
...
def create_app() -> FastAPI:
    ...
    try:
        from agent_project_template.api.factory import create_api
        from agent_project_template.core.logger import setup_logging
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Agent Project Template - AI Agent Application",
