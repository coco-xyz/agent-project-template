# Agent Project Template - Makefile
...
# Project settings
PROJECT_NAME := agent-project-template
PACKAGE_NAME := agent_project_template
...
help: ## Show this help message
	@echo "$(CYAN)Agent Project Template - Development Commands$(RESET)"
	@echo "$(CYAN)================================================$(RESET)"
	@echo ""
...
shell: ## dev - Start interactive Python shell with project context
	...
	$(PYTHON_CMD) -i -c "from agent_project_template.core.config import settings; print('Settings loaded:', settings is not None)"
...
config-check: ## Validate configuration
	...
	@$(PYTHON_CMD) -c "from agent_project_template.core.config import settings; print('✅ Configuration valid')"
...
.PHONY: setup
setup: setup-env setup-dirs test-create ## Complete project setup
