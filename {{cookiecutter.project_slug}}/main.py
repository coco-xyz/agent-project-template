...
async def run_cli_mode() -> None:
    ...
    """
    print("🤖 {{cookiecutter.project_name}} - CLI Mode")
    print("=" * 50)
    ...
    print("Welcome to the {{cookiecutter.project_name}}!")
    ...
    while True:
        try:
            ...
            if user_input.lower() in ["exit", "quit"]:
                ...
                print(
                    "   💡 Tip: Implement your agent in {{cookiecutter.project_slug}}/agents/"
                )
                print()
            else:
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="{{cookiecutter.project_name}} - AI Agent Application",
...
Examples:
  ...
  python main.py --mode api --host 127.0.0.1 --port 3000  # Custom host/port
    ...
    if args.mode == "cli":
        ...
        print("🚀 Starting {{cookiecutter.project_name}} API Server...")
