...
Comprehensive health check for the Agent Project Template API.
"""
...
from agent_project_template.api.v1.schemas.responses import HealthResponse
...
async def check_database_health() -> Dict[str, Any]:
    ...
    try:
        from agent_project_template.stores.database import test_connection
