...
Application settings and environment configuration for {{cookiecutter.project_name}}.
"""
...
class Settings(BaseSettings):
    ...
    # API settings
    api__title: str = Field(default="{{cookiecutter.project_name}}", description="API title")
