...
Centralized logfire configuration and instrumentation setup for {{cookiecutter.project_name}}.
...
def setup_logfire() -> bool:
    ...
    try:
        ...
        startup_logger = logging.getLogger("{{cookiecutter.project_slug}}.startup")
        startup_logger.info(
